...
<td align="left">
    ...
    <div id="icerik">
        <asp:ListView ID="lstContent" runat="server" GroupItemCount="5" 
            ...
            <ItemTemplate>
                <td style="height: auto; background-color: #b80000;font-weight:bold;width:150px;border-bottom:10px solid #b80000;border-radius: 10px; -moz-border-radius: 10px;-webkit-border-radius: 10px">

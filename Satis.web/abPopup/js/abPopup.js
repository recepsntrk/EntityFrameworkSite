    /**
     * * -------------------------------------------------------------------------------------------------------
     * Bu jQuery eklentisi Aycan BULBUL(http://www.aycan.net/jquery-popup-eklentisi-v2/) tarafından yapilmistir.
     * Eklenti Adi  : jQuery abPopup uygulamasi v2
     * Yazar        : Aycan BULBUL, ab@aycan.net
     * Tarih        : Tarih 03 Mayıs 2011
     * * -------------------------------------------------------------------------------------------------------
     * Kullanim klavuzu
